...
public class EarthquakeActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<List<Word>>  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i(LOG_TAG, "Test: On Create Called");
        ...
        mEmptyStateTextView = (TextView) findViewById(R.id.empty_list_text);
        ...
        if (activeNetwork != null && activeNetwork.isConnected()) {
            ...
            mEmptyStateTextView.setText("There is no internet connection");
        }
    ...
    public Loader<List<Word>> onCreateLoader(int id, Bundle args) {
        Log.i(LOG_TAG, "Test: On Creat Loader");
        SharedPreferences sharedPrefs = PreferenceManager.getDefaultSharedPreferences(this);
        String minMagnitude = sharedPrefs.getString(
                getString(R.string.settings_min_magnitude_key),
                getString(R.string.settings_min_magnitude_default));
        String minItems = sharedPrefs.getString(
                getString(R.string.settings_min_items_key),
                getString(R.string.settings_min_items_default));
        ...
        uriBuilder.appendQueryParameter("limit", minItems);
    ...
    public void onLoadFinished(Loader<List<Word>> loader, List<Word> data) {
        Log.i(LOG_TAG, "Test: on Load Finished");
        ...
        mProgressBar.setVisibility(View.GONE);
        mEmptyStateTextView.setText(" There is No Data Fetched From the Server");
    }

    @Override
    public void onLoaderReset(Loader<List<Word>> loader) {

        Log.i(LOG_TAG, "Test: on Load Reset");
