...
/**
 * Created by Ahmad on 07/02/2018.
 */
public final class QueryUtils {
    ...
    public static List<Word> extractFeatureFromJson(String earthquakeJSON) {
        ...
        try {
            ...
            for (int i = 0; i < earthquakeArray.length(); i++){
                ...
                Word thisEq = new Word(magnitude, location, time,url);

                // Add the new {@link Earthquake} to the list of earthquakes.
                earthquakes.add(thisEq);
            }
    ...
    public static List<Word> fetchEarthquakeData(String requestUrl) {
        // so we can see the Progress Bar
        try {
            Thread.sleep(1500);
        ...
        Log.v(LOG_TAG, "Test: Fetching Earthquake Data");
        // Create URL object
        ...
        try {
            ...
            Log.e("tag", "Test: Problem making the HTTP request.", e);
        }
